...
class NMT(nn.Module):
    ...
    def forward(self, source: List[List[str]], target: List[List[str]]) -> torch.Tensor:
        ...
        # source_padded = self.model_embeddings_source(source_padded_chars) # (sentence_length, batch_size, embed_size)
        # target_padded = self.model_embeddings_target(target_padded_chars)
